...
// Pure routing helpers live in lib/auth/redirects (unit-testable, no
// server-only imports); re-exported here so callers keep one import path.
export { dashboardPathForRole, postLoginDestination } from "@/lib/auth/redirects";
